...
private:
	...
	D3DXMATRIX* _tmp_D3DXMatrixReflect(D3DXMATRIX* pMat, const D3DXPLANE* pPlane);
...
void MirrorApp::initApp()
{
	...
	dsDesc.FrontFace.StencilFunc   = D3D10_COMPARISON_EQUAL;// TRY CHANGING TO D3D10_COMPARISON_ALWAYS;
...
D3DXMATRIX* MirrorApp::_tmp_D3DXMatrixReflect(D3DXMATRIX* pMat, const D3DXPLANE* pPlane)
    {
